...
if(isset($_POST['submit']))
{
    ...
    $sql = "INSERT INTO users (name, email, city, balance) VALUES ('$fname', '$email', '$city', '$balance')";
...
<div class="container">
  ...
  <path d="M0 3a2 2 0 0 1 2-2h13.5a.5.5 0 0 1 0 1H15v2a1 1 0 0 1 1 1v8.5a1.5 1.5 0 0 1-1.5 1.5h-12A2.5 2.5 0 0 1 0 12.5V3zm1 1.732V12.5A1.5 1.5 0 0 0 2.5 14h12a.5.5 0 0 0 .5-.5V5H2a1.99 1.99 0 0 1-1-.268zM1 3a1 1 0 0 0 1 1h12V2H2a1 1 0 0 0-1 1z"/>
      ...
      <ul class="nav nav-pills">
        ...
        <!-- <li class="nav-item"><a href="add.php" class="nav-link active" aria-current="page">Add users</a></li>
	...
	<section class="text-gray-600 body-font relative">
		<div class="container px-5 py-24 mx-auto">
			<div class="flex flex-col text-center w-full mb-12">
				<h1 class="sm:text-3xl text-3xl font-medium title-font mb-4 text-gray-900 font-serif">Add Users</h1>
					...
					<div class="flex flex-wrap -m-2">
						<div class="p-2 w-2/4">
							<div class="relative">
								...
								<input required type="text" id="fname" name="fname" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
							</div>
						</div>
						<div class="p-2 w-2/4">
							<div class="relative">
						...
						<div class="p-2 w-2/4">
							<div class="relative">
								...
								<input required type="text" id="city" name="city" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
							</div>
						</div>
						<div class="p-2 w-2/4">
							<div class="relative">
								<label for="balance" class="leading-7 text-sm text-gray-600">Balance</label>
								<input required type="text" id="balance" name="balance" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
							</div>
						</div>
						<div class="p-2 w-full">
							<button class="w-full rounded-full text-gray-100 text-white bg-green-600 border-0 py-2 focus:outline-none hover:bg-green-700 rounded text-lg shadow" name="submit" type="submit" id="myBtn">Add User&nbsp;<i class="fa fa-user-plus" aria-hidden="true"></i>
							</button>
              <br><br>
              <button  onclick="goBack()" class="w-full rounded-full text-gray-100 text-white bg-red-600 border-0 py-2 focus:outline-none hover:bg-red-700 rounded text-lg shadow" name="cancel" type="" id="mycancelBtn">Cancel&nbsp;<i class="fa fa-times" aria-hidden="true"></i>
							</button>
