                        ...
                        <tbody>
                            ...
                            ?>
                                <tr style="color : black;">
                                    ...
                                    <td align="center"><a href="users.php?id= <?php echo $rows['id']; ?>"> <button class="w-full rounded-full text-gray-100 text-white bg-green-500 border-0 py-2 focus:outline-none hover:bg-green-700 rounded text-lg"> View and Transact </button></a></td>
